...
const Annonce = () => {
  return (
    <div className='container min-h-96 md:min-h-64 border flex-col flex md:flex-row space-y-7 md:space-y-0 justify-evenly items-center mt-20 md:mt-36 2xl:mt-16 md:w-[90%] bg-custom-blue rounded-r-full'>
